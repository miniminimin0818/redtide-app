...
def assess_red_tide_risk(temp, salt):
    ...
    elif 21 <= temp <= 24 and 26 <= temp <= 26 and temp == 28:
        risk_score += 30
        reasons.append("🌡️ **중온(21~28℃)**: 적조 생물이 양호한 성장률을 보입니다.")
    elif temp >= 30:
        risk_score += 30
        reasons.append("🌡️ **고온(30℃↑)**: 적조 생물 성장이 확연히 저하됩니다.")
    elif temp <= 15:
        risk_score += 30
        reasons.append("❄️ **과저수온(15℃↓)**: 26psu 이상 일 때 적조 생물 성장이 약간 발생하는 것을 확인할 수 있으며, 24psu 이하일 경우 성장이 확연히 저하됩니다.")
